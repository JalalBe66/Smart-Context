            ...
            <div style={{marginTop:"10%" , marginBottom:"20%"}}>
                ...
                <div class="Container-barre-serv2">
                    <div class="question1-container">
                        <p id='title-q1'>What is the domain and the objective of the project :</p>
                        <div id='inp-q1-container'>
                            <textarea name='question1' value={values.question1} onChange={inputChange('question1')} className="inp-q1" placeholder=" What is the domain of the project ?"/>
                            <textarea name='question2' value={values.question2} onChange={inputChange('question2')} className="inp-q1"placeholder="What primary goals or aspirations drive the project forward ?"/>
                        </div>
