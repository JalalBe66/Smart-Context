...
export default function Service2() {
  let changeColorInp=()=>{
    ...
    divB.style.border="solid 1px #FF385C"
    divB.style.boxShadow="1px 1px 5px #FF385C"
      ...
      <div>
            ...
            <div id='contenu-p-serv1'>
              <div id='inp-img-serv1'>
                <input onBlur={resetColor} onFocus={changeColorInp} id='input-srv1' type="text" placeholder="Ajoutez votre projet" />
